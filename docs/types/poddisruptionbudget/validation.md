...
| `spec.unhealthyPodEvictionPolicy` | `*UnhealthyPodEvictionPolicyType` | `+k8s:optional`<br> | Optional policy for when unhealthy pods should be considered for eviction. Defaults to `IfHealthyBudget`. |
...
| :--- | :--- |
| `UnhealthyPodEvictionPolicyType` | `+k8s:enum` |
