...
| `rules` | `[]PolicyRule` | `+k8s:required` | Mandatory list of rules that apply to resources or non-resource URLs. |
...
| Field Path | Go Type | Validation Tags | Reasoning / Notes |
| :--- | :--- | :--- | :--- |
| `clusterRoleSelectors` | `[]metav1.LabelSelector` | `+k8s:required` | Mandatory list of selectors used to find ClusterRoles and create the rules. |