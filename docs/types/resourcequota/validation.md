...
| `spec.scopes` | `[]ResourceQuotaScope` | `+k8s:optional`<br>`+k8s:immutable` | Optional collection of filters that must match each object tracked by a quota. Immutable after creation. |
