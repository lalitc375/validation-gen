...
| `spec.storageClassName` | `string` | `+k8s:optional`<br>`+k8s:format=k8s-long-name` | Optional name of the StorageClass to which this volume belongs. |
...
| `spec.glusterfs.endpoints` | `string` | `+k8s:required`<br>`+k8s:format=k8s-long-name` | Mandatory endpoints name. |
| `spec.glusterfs.endpointsNamespace` | `*string` | `+k8s:optional`<br>`+k8s:format=k8s-short-name` | Optional endpoints namespace. |
...
| `spec.quobyte.tenant` | `string` | `+k8s:optional`<br>`+k8s:format=k8s-uuid` | Optional tenant UUID. |
...
| `spec.storageos.volumeName` | `string` | `+k8s:optional`<br>`+k8s:format=k8s-short-name` | Optional volume name. |
| `spec.storageos.volumeNamespace` | `string` | `+k8s:optional`<br>`+k8s:format=k8s-short-name` | Optional volume namespace. |
| `spec.csi` | `*CSIPersistentVolumeSource` | `+k8s:unionMember`<br/>`+k8s:optional` | CSI. |
| `spec.csi.driver` | `string` | `+k8s:required`<br>`+k8s:format=k8s-long-name` | Mandatory driver name. |
