...
| `spec.updateStrategy.type` | `DaemonSetUpdateStrategyType` | `+k8s:optional`<br>`+k8s:enum=["RollingUpdate", "OnDelete"]` | Strategy type for updates. Defaults to `RollingUpdate`. |
