# Validation: MutatingWebhookConfiguration
...
| `webhooks` | `[]MutatingWebhook` | `+k8s:optional`<br>`+k8s:listType=map`<br>`+k8s:listMapKey=name` | List of webhooks and the affected resources and operations. |
