...
| `spec.source.persistentVolumeName` | `*string` | `+k8s:optional` | Optional name of the PersistentVolume being attached. |
| `spec.source.inlineVolumeSpec` | `*PersistentVolumeSpec` | `+k8s:optional` | Optional inline specification of a volume. |
