...
| `http.paths` | `[]HTTPIngressPath` | `+k8s:required`<br>`+k8s:minItems=1`<br>`+k8s:listType=atomic` | Mandatory collection of paths. |
...
| Field Path | Go Type | Validation Tags | Reasoning / Notes |
| :--- | :--- | :--- | :--- |
| `hosts` | `[]string` | `+k8s:optional`<br>`+k8s:eachVal=+k8s:format=hostname`<br>`+k8s:listType=atomic` | Optional list of hosts. |
