...
| `preemptionPolicy` | `*PreemptionPolicy` | `+k8s:optional`<br>`+k8s:immutable` | Optional policy for preempting pods with lower priority. Defaults to `PreemptLowerPriority`. Immutable after creation. |
