...
func Validate_AggregationRule(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *AggregationRule) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []metav1.LabelSelector, oldValueCorrelated bool) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("clusterRoleSelectors"), obj.ClusterRoleSelectors, safe.Field(oldObj, func(oldObj *AggregationRule) []metav1.LabelSelector { return oldObj.ClusterRoleSelectors }), oldObj != nil)...)
