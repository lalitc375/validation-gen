...
func Validate_T1(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *T1, runAllValidations bool) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T1) (errs field.ErrorList) {
			...
			errs = append(errs, primitives.Validate_T1(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *primitives.T2) (errs field.ErrorList) {
			...
			// call the type's validation function
			errs = append(errs, primitives.Validate_T2(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E1) (errs field.ErrorList) {
			...
			// call the type's validation function
			errs = append(errs, typedefs.Validate_E1(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E2) (errs field.ErrorList) {
			...
			// call the type's validation function
			errs = append(errs, typedefs.Validate_E2(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E3) (errs field.ErrorList) {
			...
			// call the type's validation function
			errs = append(errs, typedefs.Validate_E3(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *typedefs.E4) (errs field.ErrorList) {
			...
			// call the type's validation function
			errs = append(errs, typedefs.Validate_E4(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
