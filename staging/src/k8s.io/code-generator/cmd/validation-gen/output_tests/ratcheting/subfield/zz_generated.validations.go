...
// to declarative validation rules in the API schema.
func Validate_StructWithSubfield(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *StructWithSubfield, runAllValidations bool) (errs field.ErrorList) {
	if runAllValidations {
		func() { // cohort intField
