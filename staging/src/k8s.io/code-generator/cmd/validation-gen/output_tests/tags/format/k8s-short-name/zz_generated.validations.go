...
func Validate_ShortNameStringType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *ShortNameStringType, runAllValidations bool) (errs field.ErrorList) {
...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct, runAllValidations bool) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *ShortNameStringType) (errs field.ErrorList) {
			...
			errs = append(errs, Validate_ShortNameStringType(ctx, op, fldPath, obj, oldObj, runAllValidations)...)
			return
