...
func Validate_Scale(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *autoscalingv1.Scale, runAllValidations bool) (errs field.ErrorList) {
...
// to declarative validation rules in the API schema.
func Validate_ScaleSpec(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *autoscalingv1.ScaleSpec, runAllValidations bool) (errs field.ErrorList) {
